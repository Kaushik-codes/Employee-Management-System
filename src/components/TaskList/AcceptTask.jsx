    ...
    <div>
      <div className="shrink-0 w-72 bg-amber-400/10 border border-amber-400/20 hover:border-amber-400/40 transition-all duration-200 h-full rounded-2xl px-5 py-6 flex flex-col justify-between">
        ...
        <div className="mt-6 flex gap-2">
          <button
            className="flex-1 bg-emerald-400/10 hover:bg-emerald-400/20 text-emerald-400 border border-emerald-400/20 hover:border-emerald-400/40 px-3 py-2 rounded-xl text-xs font-semibold cursor-pointer transition-all duration-200"
            onClick={handleComplete}
          >
            ✓ Completed
          </button>
          <button
            className="flex-1 bg-rose-400/10 hover:bg-rose-400/20 text-rose-400 border border-rose-400/20 hover:border-rose-400/40 px-3 py-2 rounded-xl text-xs font-semibold cursor-pointer transition-all duration-200"
